    ...
    <>
      ...
      >
        <div className="container mx-auto px-4 sm:px-6">
          <motion.nav 
            className={`flex items-center justify-between rounded-full backdrop-blur-lg border border-[#60a5fa]/20 ${
              scrolled 
                ? 'bg-[#0b1220]/90 shadow-lg shadow-[#60a5fa]/10' 
                : 'bg-[#0b1220]/75'
          ...
          >
            ...
            >
              <motion.div 
                className="w-8 h-8 md:w-9 md:h-9 rounded-full bg-gradient-to-br from-[#60a5fa] to-[#2563eb] flex items-center justify-center overflow-hidden relative"
                whileHover={{ 
              ...
              <div className="ml-2 md:ml-3 overflow-hidden">
                ...
                >
                  ...
                  <motion.span 
                    className="text-[#60a5fa] font-semibold ml-1"
                    animate={{ color: ['#60a5fa', '#1e40af', '#60a5fa'] }}
                ...
                <motion.div
                  className="h-[2px] w-full bg-gradient-to-r from-[#60a5fa]/10 via-[#60a5fa]/60 to-[#60a5fa]/10"
            ...
            <div className="hidden lg:flex items-center gap-2">
                ...
                <motion.button
                  ...
                  className={`px-4 py-2 rounded-lg text-sm font-medium transition-all relative overflow-hidden ${
                    activeLink === link.name
                      ? 'text-white bg-gradient-to-r from-[#60a5fa]/20 to-[#2563eb]/20 border border-[#60a5fa]/30'
                      : 'text-[#e9d8fd]/80 hover:text-white border border-transparent hover:border-[#60a5fa]/20'
                  }`}
                  whileHover={{ y: -2 }}
                  whileTap={{ scale: 0.97 }}
                >
                  ...
                  {isHovered === link.name && activeLink !== link.name && (
                    <motion.div 
                      className="absolute inset-0 bg-gradient-to-r from-[#60a5fa]/5 to-[#2563eb]/5 rounded-lg"
                  ...
                  <div className="relative z-10 flex items-center gap-2">
                    <span className={activeLink === link.name ? 'text-[#60a5fa]' : 'text-[#60a5fa]/60'}>
                      {link.icon}
                    </span>
                    <span>{link.name}</span>
                  </div>
                  ...
                  {activeLink === link.name && (
                    <motion.div 
                      className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-[#60a5fa]/50 via-[#1e40af] to-[#60a5fa]/50"
              ...
              <div className="h-6 w-px bg-[#60a5fa]/20 mx-1"></div>
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  <motion.div 
                    className="absolute inset-0 rounded-full bg-gradient-to-b from-[#60a5fa]/20 to-[#2563eb]/10 opacity-0 hover:opacity-100 transition-opacity"
                  />
                ...
                >
                  ...
                  <span className="text-sm font-semibold relative z-10">CV</span>
                  <motion.div
              ...
              <div className="relative w-6 h-5 flex flex-col justify-between">
                <motion.span 
                  ...
                  animate={{ 
                    ...
                    backgroundColor: mobileMenuOpen ? '#60a5fa' : '#ffffff'
                  }}
                  transition={{ duration: 0.3 }}
                />
                <motion.span 
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <>
            ...
            {/* Panel de menú móvil */}
            <motion.div 
              className="fixed right-0 top-0 h-full w-[80%] max-w-xs bg-[#12121f]/95 z-50 border-l border-[#60a5fa]/20 backdrop-blur-md flex flex-col"
              initial={{ x: '100%' }}
              animate={{ x: 0 }}
              exit={{ x: '100%' }}
            ...
            >
              ...
              <div className="flex items-center justify-between p-5 border-b border-[#60a5fa]/20">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#60a5fa] to-[#2563eb] flex items-center justify-center">
                ...
                {navLinks.map((link, index) => (
                  <motion.button
                    ...
                    className={`w-full px-4 py-3 rounded-lg flex items-center gap-3 text-left ${
                      activeLink === link.name
                        ? 'bg-gradient-to-r from-[#60a5fa]/20 to-[#2563eb]/20 text-white border border-[#60a5fa]/30'
                        : 'text-[#e9d8fd]/80 hover:text-white border border-transparent hover:bg-[#0b1220]/60'
                    }`}
                  ...
                  >
                    ...
                    {activeLink === link.name && (
                      <motion.span 
                        className="ml-auto w-1.5 h-1.5 rounded-full bg-[#60a5fa]"
              ...
              <div className="p-5 border-t border-[#60a5fa]/20">
                <div className="flex justify-between items-center">
                  <div className="flex gap-3">
                    <motion.a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="p-2.5 rounded-lg bg-[#0b1220]/60 text-[#60a5fa]/80 hover:text-[#60a5fa]"
                      whileHover={{ y: -2, backgroundColor: 'rgba(11, 18, 32, 0.8)' }}
                      whileTap={{ scale: 0.95 }}
                      aria-label="GitHub"
                    >
