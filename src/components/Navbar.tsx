      ...
      >
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            ...
            {/* Iconos sociales - versión móvil */}
            <div className="flex md:hidden items-center gap-2">
              <motion.a
                href="https://github.com/Vixtor120"
                target="_blank"
                rel="noreferrer"
                className="p-1.5 rounded-full text-[#e9d8fd]/80 hover:text-white bg-[#1a1433]/40 border border-[#9f7aea]/20"
              ...
              <motion.a
                href="/cv.pdf"
                download
                className="p-1.5 rounded-full text-[#e9d8fd]/80 hover:text-white bg-gradient-to-r from-[#9f7aea]/30 to-[#6b46c1]/30 border border-[#9f7aea]/30"
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
                aria-label="Descargar CV"
              >
