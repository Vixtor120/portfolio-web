  ...
  return (
    <>
      ...
      >
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              <motion.div 
                className="w-9 h-9 rounded-full bg-gradient-to-br from-[#8b5cf6] to-[#6b46c1] flex items-center justify-center overflow-hidden relative"
                whileHover={{ 
              ...
              >
                ...
                />
                <span className="relative z-10 text-white font-bold">VH</span>
              </motion.div>
              {!isMobile && (
                <div className="ml-3 overflow-hidden">
                  <motion.span 
                    className="block text-white text-lg font-medium tracking-wide relative"
                  ...
                  >
                    Victor
                    <motion.span 
                      className="text-[#9f7aea] font-semibold ml-1 inline-block"
                      animate={{ y: [0, -2, 0], color: ['#9f7aea', '#8b5cf6', '#9f7aea'] }}
            ...
            <motion.button
              ...
              className="md:hidden p-2.5 rounded-xl bg-gradient-to-r from-[#9f7aea]/20 to-[#6b46c1]/10 text-[#e9d8fd]/90 hover:text-white border border-[#9f7aea]/20"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            className="fixed top-[4.5rem] left-0 w-full z-40 px-4"
          ...
          >
            <motion.div 
              className="bg-[#121212]/95 backdrop-blur-md border border-[#9f7aea]/20 rounded-2xl shadow-xl p-4 overflow-hidden"
            >
                ...
                {navLinks.map((link) => (
                  <motion.button
                    ...
                    className={`w-full px-4 py-3 rounded-lg text-left flex items-center gap-3 ${
                      activeLink === link.name
                        ? 'bg-gradient-to-r from-[#9f7aea]/20 to-[#6b46c1]/10 text-white border-l-2 border-[#9f7aea]/70'
                        : 'text-[#e9d8fd]/80 hover:bg-[#2d3748]/20 hover:text-white'
                    } transition-all`}
                    whileHover={{ x: 3 }}
                    whileTap={{ scale: 0.98 }}
                  >
              ...
              {/* Enlaces sociales móviles */}
              <div className="border-t border-[#9f7aea]/10 pt-3 flex justify-center space-x-6">
                <motion.a
                  href="https://github.com/Vixtor120"
                  target="_blank"
                  rel="noreferrer"
                ...
                {/* Botón de CV mejorado para móvil */}
                <motion.a
                  href="/cv.pdf"
                  download
                  className="flex flex-col items-center justify-center gap-1 p-1 text-[#e9d8fd]/90 hover:text-white"
                  whileHover={{ scale: 1.1, y: -2 }}
                  whileTap={{ scale: 0.9 }}
                  aria-label="Descargar CV"
                >
                  <div className="p-1.5 rounded-full bg-gradient-to-r from-[#9f7aea]/30 to-[#6b46c1]/20 flex items-center justify-center">
