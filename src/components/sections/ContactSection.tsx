        ...
        >
          ...
          >
            ...
            <div className="space-y-6">
              {/* Protected Email */}
              <motion.div
                className="flex items-center justify-between gap-4 group p-2 rounded-xl hover:bg-[#60a5fa]/5 transition-all"
                variants={itemVariants}
                whileHover={{ x: 5 }}
              >
                <div className="flex items-center gap-4 flex-1 min-w-0">
                  <div className="p-3 rounded-lg bg-[#0b1220]/60 text-[#60a5fa] group-hover:bg-[#0b1220]/80 transition-all flex-shrink-0">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {emailRevealed ? (
                      <a
                        ...
                        className="text-white hover:text-[#60a5fa] transition-colors font-medium break-all"
                      >
                        {getEmail()}
                      </a>
                    ) : (
                      <p className="text-[#e9d8fd]/40 font-mono text-sm tracking-widest select-none">
                        vic••••••••••••@gmail.com
                      </p>
                    )}
                  </div>
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  {!emailRevealed ? (
                    <button
                      ...
                      className="px-3 py-1.5 rounded-lg text-xs font-semibold bg-[#60a5fa]/10 text-[#60a5fa] hover:bg-[#60a5fa]/20 border border-[#60a5fa]/20 transition-all flex items-center gap-1.5"
                      title="Mostrar email para humanos"
                    >
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 rounded-lg text-xs font-semibold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 hover:bg-emerald-500/20 transition-all flex items-center gap-1.5"
                    >
                      {copiedType === 'email' ? '✓ Copiado' : 'Copiar'}
                    </button>
                  )}
                </div>
              </motion.div>
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  {!phoneRevealed ? (
                    <button
                      ...
                      className="px-3 py-1.5 rounded-lg text-xs font-semibold bg-[#60a5fa]/10 text-[#60a5fa] hover:bg-[#60a5fa]/20 border border-[#60a5fa]/20 transition-all flex items-center gap-1.5"
                      title="Mostrar teléfono para humanos"
                    >
                      <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 rounded-lg text-xs font-semibold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 hover:bg-emerald-500/20 transition-all flex items-center gap-1.5"
                    >
                      {copiedType === 'phone' ? '✓ Copiado' : 'Copiar'}
                    </button>
                  )}
                </div>
              </motion.div>
