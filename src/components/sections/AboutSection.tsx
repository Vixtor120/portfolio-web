            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <span className="text-[#e9d8fd]/90 text-sm">Barcelona - Santa Coloma de Gramanet</span>
                </motion.div>
              </div>
                ...
                {activeTab === 'about' && (
                  ...
                  >
                    ...
                    <p className="leading-relaxed">
                      El desarrollo de software no es solo escribir líneas de código, sino dar vida a ideas que transforman la sociedad. Actualmente, curso el ciclo formativo de Desarrollo de Aplicaciones Web (DAW), donde combino lógica y creatividad para construir soluciones tecnológicas con impacto real.
                    </p>
                    
                    <p className="leading-relaxed">
                      Colaboro con Guttman en el desarrollo de juegos neuropsicológicos, creando herramientas interactivas que contribuyen a la salud cognitiva. Este proyecto me está permitiendo explorar cómo la tecnología puede mejorar la vida de las personas.
                    </p>
                    
                    <div className="mt-4 pt-4 border-t border-[#9f7aea]/10">
                      <h4 className="text-lg font-medium text-white mb-2">Mi objetivo</h4>
                      <p className="leading-relaxed">
                        Mi objetivo es seguir creciendo profesionalmente en el sector tecnológico, especializándome en desarrollo web y explorando las intersecciones entre tecnología, innovación y bienestar social.
                      </p>
                    </div>
                  </motion.div>
                )}
